-- Fix schema mismatch for notifications table
-- The table was likely created with an old schema, preventing the new schema from being applied.

DROP TABLE IF EXISTS public.notifications CASCADE;

-- Re-create Notifications Table with correct schema
